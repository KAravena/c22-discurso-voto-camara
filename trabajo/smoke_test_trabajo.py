...
html_path = Path(r"D:\CEP\Mar - intervenciones\Nominate\web_tematicos\trabajo_tbip_nominate.html")
...
if "trabajo" != "seguridad":
    assert "Seguridad en la Cámara: discurso y votación" not in text, "Quedó título fijo de seguridad"
assert "Trabajo en la Cámara: discurso y votación" in text, "No aparece título correcto"
for required in [
    "c22-site-header",
    "c22-site-footer",
...
assert data["theme"] == "trabajo", "DATA.theme no coincide"
