...
html_path = Path(r"D:\CEP\Mar - intervenciones\Nominate\web_tematicos\educacion_tbip_nominate.html")
...
if "educacion" != "seguridad":
    assert "Seguridad en la Cámara: discurso y votación" not in text, "Quedó título fijo de seguridad"
assert "Educación en la Cámara: discurso y votación" in text, "No aparece título correcto"
for required in [
    "c22-site-header",
    "c22-site-footer",
...
assert data["theme"] == "educacion", "DATA.theme no coincide"
