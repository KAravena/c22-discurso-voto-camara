...
html_path = Path(r"D:\CEP\Mar - intervenciones\Nominate\web_tematicos\salud_tbip_nominate.html")
...
assert "Salud en la Cámara: discurso y votación" in text, "No aparece título correcto"
for required in [
    "c22-site-header",
    "c22-site-footer",
...
assert data["theme"] == "salud", "DATA.theme no coincide"
