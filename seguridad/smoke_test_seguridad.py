...
html_path = Path(r"D:\CEP\Mar - intervenciones\Nominate\web_tematicos\seguridad_tbip_nominate.html")
...
assert "Seguridad en la Cámara: discurso y votación" in text, "No aparece título correcto"
for required in [
    "c22-site-header",
    "c22-site-footer",
...
assert data["theme"] == "seguridad", "DATA.theme no coincide"
